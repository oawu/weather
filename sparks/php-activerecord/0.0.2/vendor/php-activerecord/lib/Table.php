...
class Table
{
	...
	private function set_append_conditions()
	{
		if ($append_conditions = $this->class->getStaticPropertyValue('append_conditions',array ()))
			$this->append_conditions = $append_conditions;
		else
		  $this->append_conditions = array ();
	}
