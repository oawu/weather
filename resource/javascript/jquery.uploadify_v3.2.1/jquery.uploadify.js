...
(function($) {
	...
	var methods = {
		...
		cancel : function(fileID, supressEvent) {
			...
			this.each(function() {
              ...
              if (settings.onRemoveCompleted)
                settings.onRemoveCompleted.call(swfuploadify, $('#' + args[n]));
              else
		...
		onSelect : function(file) {
			...
			for (var n in this.queueData.files) {
				...
				if (queuedFile.uploaded != true && queuedFile.name == file.name) {
					...
					if (settings.checkFileNameDouble && !confirm('The file named "' + file.name + '" is already in the queue.\nDo you want to replace the existing item in the queue?')) {
    ...
    onRemoveCompleted: function () {
      if (this.settings.onRemoveCompleted) this.settings.onRemoveCompleted.call(this);
    },
		...
		onUploadComplete : function(file) {
			...
			if ($.inArray('onUploadComplete', settings.overrideEvents) < 0) {
              ...
              var that = this;
                  ...
                  //  $(this).remove();
                  // });
                  if (that.settings.onRemoveCompleted)
                    that.settings.onRemoveCompleted.call(that, $('#' + file.id));
                  else
                    $('#' + file.id).fadeOut(500, function() {
  										$(this).remove();
  									});
