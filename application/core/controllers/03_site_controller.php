...
class Site_controller extends Oa_controller {
  ...
  private function _add_meta () {
    return $this->add_meta (array ('name' => 'viewport', 'content' => 'width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, minimal-ui'))
                ...
                ->add_meta (array ('name' => 'description', 'content' => '想查詢每個地方的天氣嗎！藉由 Google Maps 的地圖服務，以及 OpenWeatherMap 的天氣 API 服務，讓你輕鬆快速地查詢到知名景點的天氣概況！天氣概況每 30 分鐘會更新一次，天氣內容僅供參考！'))
                ->add_meta (array ('property' => 'og:site_name', 'content' => 'Weather Maps'))
                ->add_meta (array ('property' => 'og:title', 'content' => 'Weather Maps'))
                ->add_meta (array ('property' => 'og:description', 'content' => '想查詢每個地方的天氣嗎！藉由 Google Maps 的地圖服務，以及 OpenWeatherMap 的天氣 API 服務，讓你輕鬆快速地查詢到知名景點的天氣概況！天氣概況每 30 分鐘會更新一次，天氣內容僅供參考！'))
