...
class MY_Loader extends CI_Loader
{
    ...
    public function controller ($file_name, $method_name = 'index') {
        $params = array ();
        ...
        $file_path = APPPATH . 'controllers' . DIRECTORY_SEPARATOR . $file_name . EXT;
        ...
        if (file_exists ($file_path)) {
            ...
            if (in_array (strtolower ($method_name), array_map ('strtolower', get_class_methods ($object)))) {
                $object->set_class ($file_name)->set_method ($method_name);
                call_user_func_array (array ($object, $method_name), $params);
            }
        }
        else {
