...
<?php
    ...
    <form action='<?php echo base_url (array ('admin', 'towns', 'cate_update_town', $town->id));?>' method='post' enctype='multipart/form-data'>
      <table class='table-form'>
        <tbody>
          <tr>
            <th>縣市</th>
            <td>
              <input type='hidden' name='town_category_id' value='<?php echo $town->category->id;?>' />
              <input type='text' id='town_category_name' name='town_category_name' value='<?php echo $town->category->name;?>' readonly />
            </td>
          </tr>
          <tr>
            <th>名稱</th>
